...
<div class="row">
	<div class="col-sm-4">
		<form id="frmVentasProductos">
			...
			<span class="btn btn-danger" id="btnVaciarVentas">Vaciar rentas</span>
		</form>
	</div>
	<div class="col-sm-3">
		...
		$.ajax({
			...
			success:function(r){
				if(r > 0){
					...
					alertify.alert("Renta realizada exitosamente, consulte  la informacion de esta en rentas hechas");
				}else if(r==0){
