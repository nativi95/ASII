...
<body>
  ...
  <!-- Begin Navbar -->
  <div id="nav">
  <div class="navbar-light bg-success navbar-fixed-top" data-spy="affix" data-offset-top="100" >
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/Logo3.JPEG" alt="" width="250px" height="250px"></a>
        </div>
        ...
        if($_SESSION['usuario']=="admin"):
         ...
         <?php 
          ...
          <li><a href="ventas.php"><span class="glyphicon glyphicon-usd"></span>Rentar Equipo</a>
          </li>
